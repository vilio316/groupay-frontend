...
const navLinks = [
  ...
  { href: "/notifications", label: "Notifications",  Icon: BellIcon, badge: 3 },
];
    ...
    >
            ...
            >
              ...
              <Icon
                ...
                className={`h-4.5 w-4.5 shrink-0 transition-transform duration-150 ${
                  active ? "text-white" : "text-ink-mid group-hover:text-forest group-hover:scale-110"
                }`}
              />
      ...
      <div className="mt-3 flex items-center gap-2.5 px-3 py-2.5 rounded-xl bg-[#f5faf5] border border-[#e8efe8]">
        ...
        <div className="flex-1 min-w-0">
          <p className={`${soraClass} text-[13px] font-semibold text-forest truncate leading-tight`}>
            Your Account
          </p>
